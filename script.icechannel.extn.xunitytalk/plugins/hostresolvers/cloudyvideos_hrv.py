...
class CloudyVideos(HostResolver, CustomSettings):
    implements = [HostResolver, CustomSettings]
    name = "CloudyVideos"
    resolverName = name.title()+' (Resolver)'
    match_list = ['cloudyvideos.com']
    version = '0.1'
    ...
    def Resolve(self, url):
        ...
        try:
            ...
            secs = re.search(r'wn_str\"\>Wait \<span id=\".*?\"\>(\d+)\<\/spa',html,re.I)
