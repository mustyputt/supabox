...
class noobroom(MovieIndexer,TVShowIndexer,MovieSource,TVShowSource,CustomSettings):
    implements = [MovieIndexer,TVShowIndexer,MovieSource,TVShowSource,CustomSettings]
    
    name = "noobroom"
    display_name = "[COLOR royalblue]N[/COLOR][COLOR orange]oobroom[/COLOR]"
    base_url = 'http://superchillin.com/'
    img='https://raw.githubusercontent.com/Coolwavexunitytalk/images/4dea044c0741e4f5d4a2abea34bda44ab75442f2/Noobroom.png'
    ...
    def ExtractContentAndAddtoList(self, indexer, section, url, type, list, page='', total_pages='', sort_by='', sort_order=''): 
        if section == 'latest':
            ...
            if tv_user == 'Enter your noobroom email' or tv_pwd == 'xunity' or tv_user == '' or tv_pwd == '':
    ...
    def GetSection(self, indexer, section, url, type, list, page='', total_pages='', sort_by='', sort_order=''):
        ...
        if indexer == common.indxr_Movies:#'[COLOR orange]'+year+'[/COLOR]'
            ...
            if section == 'main':
                self.AddSection(list, indexer,'latest','[COLOR royalblue]Ordered[/COLOR] [COLOR orange]by Latest[/COLOR]',self.base_url +'latest.php',indexer)
                self.AddSection(list, indexer,'azlist','[COLOR royalblue]Ordered[/COLOR] [COLOR orange]by A-Z[/COLOR]',self.base_url +'azlist.php',indexer)
                self.AddSection(list, indexer,'year','[COLOR royalblue]Ordered[/COLOR] [COLOR orange]by Release Date[/COLOR]',self.base_url +'year.php',indexer)
                self.AddSection(list, indexer,'rating','[COLOR royalblue]Ordered[/COLOR] [COLOR orange]by IMDb Rating[/COLOR]',self.base_url +'rating.php',indexer)
                self.AddSection(list, indexer,'genre','[COLOR royalblue]Ordered[/COLOR] [COLOR orange]by Genre[/COLOR]',self.base_url +'genre.php',indexer)
                self.AddSection(list, indexer,'kids','[COLOR royalblue]Kids[/COLOR] [COLOR orange]Zone[/COLOR]',self.base_url +'kids.php',indexer)
                self.AddSection(list, indexer,'random','[COLOR royalblue]Random[/COLOR] [COLOR orange]Movie[/COLOR]',self.base_url + 'random.php',indexer)            
            ...
            if section == 'main':
                self.AddSection(list, indexer,'tvshows','[COLOR royalblue]TV-Shows[/COLOR] [COLOR orange]List[/COLOR]',self.base_url +'series.php',indexer)
                self.AddSection(list, indexer,'tvshowsadded','[COLOR royalblue]Most Recently[/COLOR] [COLOR orange]Updated[/COLOR]','http://superchillin.com/series.php?bl=1',indexer)
                self.AddSection(list, indexer,'tvshowsadded','[COLOR royalblue]Series List[/COLOR] [COLOR orange]Alphabetically[/COLOR]','http://superchillin.com/series.php?dl=1',indexer)
    ...
    def GetFileHosts(self, url, list, lock, message_queue):
        ...
        if self.Settings().get_setting('premium')=='true':                
            self.AddFileHost(list, 'HD', resolved_url, 'NOOBROOM.COM')
            if 'Watch in 1080p' in content:
                self.AddFileHost(list, 'HD', resolved_url+'&hd=1', 'NOOBROOM.COM 1080P')
        else:
            self.AddFileHost(list, 'HD', resolved_url, 'NOOBROOM.COM')
