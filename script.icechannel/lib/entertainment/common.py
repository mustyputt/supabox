...
def _update_settings_xml():
    ...
    try:
        ...
        try:
            ...
            f.write('<setting id="Default_themeurl" type="text" label="Theme URL" default="https://istream-xbmc-repo.googlecode.com/svn/images/default/" visible="false"/>\n')
            ...
            f.write('<setting id="movie-view" type="number" label="     Movies View" default="503" enable="!eq(-3,false)"/>\n')   
            f.write('<setting id="tvshow-view" type="number" label="     TV Shows View" default="503" enable="!eq(-4,false)"/>\n')
