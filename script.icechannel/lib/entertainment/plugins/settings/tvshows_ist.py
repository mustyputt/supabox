...
class TVShows(iStreamSettings):
    ...
    def Initialize(self):
        ...
        xml += '<setting id="sort_hosts_1" type="text" enable="eq(-2,true)" label="     Hosts [COLOR gold][I](1)[/I][/COLOR]" default="FURK.NET,EASYNEWS,SIMPLYMOVIES.NET,MOVIESTORM.EU,TVONLINE.CC"/>\n'
