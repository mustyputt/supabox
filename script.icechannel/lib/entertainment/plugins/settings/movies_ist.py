...
class Movies(iStreamSettings):
    ...
    def Initialize(self):
        ...
        xml += '<setting id="autoplay_skip_interval" type="labelenum" values="2|5|10|15|20|25|30" label="     Time (in seconds), to skip to next host if STOP pressed" default="5" enable="eq(-1,true)"/>\n'
        xml += '<setting type="sep"/>\n'
        ...
        xml += '<setting id="sort_hosts_1" type="text" enable="eq(-2,true)" label="     Hosts [COLOR gold][I](1)[/I][/COLOR]" default="FURK.NET,EASYNEWS,SIMPLYMOVIES.NET,MUCHMOVIES.ORG,MOVIESTORM.EU,YIFY.TV"/>\n'
        ...
        xml += '<setting id="sort_hosts_4" type="text" enable="eq(-5,true)" label="     Hosts [COLOR gold][I](4)[/I][/COLOR]" default="NOWVIDEO.CH,NOWVIDEO.SX,NOWVIDEO.EU,WATCHFREEINHD.COM"/>\n'
        xml += '<setting id="sort_hosts_5" type="text" enable="eq(-6,true)" label="     Hosts [COLOR gold][I](5)[/I][/COLOR]" default="SHARESIX.COM,ZALAA.COM,MOVREEL.COM,FILENUKE.COM"/>\n'
        xml += '</category>\n' 
