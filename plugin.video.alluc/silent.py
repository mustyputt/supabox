...
#Favorites
##########
def addFavorite(name,url,types):
     print name
     print url
     print types
...
def removeFavorite(name,url,types):
    print name
    print url
    print types
    saved_favs = cache.get('favourites')
