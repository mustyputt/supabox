...
fanart=xbmc.translatePath(os.path.join('special://home','addons','plugin.video.supaboxmaintenance','fanart.jpg'))
iconart=xbmc.translatePath(os.path.join('special://home','addons','plugin.video.supaboxmaintenance','icon.png'))
SETTINGS_PATH=xbmc.translatePath(os.path.join('special://profile','addon_data','plugin.video.supaboxmaintenance','settings.xml'))
