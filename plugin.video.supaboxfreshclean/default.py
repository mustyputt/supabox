...
# Entry point
def run():
    plugintools.log("freshclean.run")
...
def main_list(params):
    plugintools.log("freshclean.main_list "+repr(params))
    ...
    if yes_pressed:
        addonPath = xbmcaddon.Addon(id = 'plugin.video.supaboxfreshclean').getAddonInfo('path')
        ...
        addonPath1 = xbmcaddon.Addon(id = 'plugin.video.supaboxfreshclean').getAddonInfo('path')
        ...
        plugintools.log("freshclean.main_list xbmcPath="+xbmcPath)
        failed=False
        ...
        try:
            ...
            if not failed:
                plugintools.log("freshclean.main_list All cache files removed, you now have more space.")
                plugintools.message("Supabox Fresh Clean", "Cleaned System!")
            else:
                plugintools.log("freshclean.main_list addon packages partially removed")
                plugintools.message("Supabox Fresh Clean", "Failed to clean system!")
        except:
            plugintools.log("freshclean.main_list NOT removed")
